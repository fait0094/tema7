...
// document.querySelectorAll("article").classList.toggle("skygge");
// document.querySelectorAll("article").classList.add("skygge");

// document.querySelectorAll("article").addEventListener("mouseover", shadow);
// document.querySelectorAll("article").addEventListener("mouseout", shadow);
